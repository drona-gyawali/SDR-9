...
import { Download, Users, Wifi, Star, FileText, AlertTriangle, ShieldCheck, ArrowDownToLine, Loader2, CheckCircle2 } from "lucide-react";
            ...
            <nav className="border-b border-zinc-200 dark:border-zinc-800/50 bg-white/70 dark:bg-[#09090b]/70 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <div className={`hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-black tracking-widest border transition-all ${connected
                                        ...
                                        {receivedFiles.map((file) => (
                                            <div key={file.id} className="group relative flex items-center justify-between p-4 bg-white dark:bg-zinc-950/30 border border-zinc-100 dark:border-zinc-800/60 rounded-[1.8rem] hover:border-zinc-300 dark:hover:border-zinc-700 transition-all">
                                                <div className="flex items-center gap-4 flex-1">
                                                    <div className={`p-3.5 rounded-2xl transition-all duration-500 ${file.status === 'complete'
                                                ...
                                                <div className="flex items-center gap-6">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-bold text-sm transition-all active:scale-95 shadow-lg ${file.status === 'complete'
